...
function EnviarCorreo($CUIT, $Nombre, $Apellido, $Correo){
    ...
    //Recipients
        ...
        $mail->addAddress($Correo, $Apellido);          // Add a recipient / Name is optional
          $mail->IsHTML(true);
    ...
    // Content
        $mail->Subject = 'Street Parking - Validación de registro';
        $mail->AltBody = 'Gracias por registrarse en Street Parking, a continuación debera activar su cuenta.';
        $mail->msgHTML('
            ...
            <tr>
              <td style="padding-top:0;padding-bottom:0;padding-right:0;padding-left:0;"><!-- ======= start header ======= -->
                ...
                <table class="one-column" border="0" cellpadding="0" cellspacing="0" width="100%" style="border-spacing:0; border-left:1px solid #e8e7e5; border-right:1px solid #e8e7e5; border-bottom:1px solid #e8e7e5; border-top:1px solid #e8e7e5" bgcolor="#FFFFFF">
                  <tr>
                    <td align="left" style="padding:50px 50px 50px 50px"><p style="color:#262626; font-size:24px; text-align:left; font-family: Verdana, Geneva, sans-serif"><strong>Hola '.$Apellido.' '.$Nombre.'</strong>,</p>
                      <p style="color:#000000; font-size:16px; text-align:left; font-family: Verdana, Geneva, sans-serif; line-height:22px ">Gracias por registrarte en nuestro sitio web. <br><br>
A continuación deberás hacer click en el siguiente botón, para validadar tu cuenta. <br />
                        <br />
                      </p>
                ...
                <table class="one-column" border="0" cellpadding="0" cellspacing="0" width="100%" style="border-spacing:0; border-left:1px solid #e8e7e5; border-right:1px solid #e8e7e5; border-bottom:1px solid #e8e7e5; border-top:1px solid #e8e7e5" bgcolor="#FFFFFF">
                  <tr>
                    <td align="center" style="padding:50px 50px 50px 50px">
                      <p style="color:#262626; font-size:41px; text-align:center; font-family: Century, Geneva, sans-serif">
                      <strong>Su cuenta ha sido creada satisfactoriamente.</strong>
                      </p>
                      <p style="color:#000000; font-size:25px; text-align:center; font-family: Century, Geneva, sans-serif; line-height:22px ">Hemos enviado un mensaje de verificación, <br><br>
Por favor ingrese a su correo electrónico y valide su cuenta para comenzar a utilizarla.<br />
                        <br />
                      </p>
                      <table border="0" align="center" cellpadding="0" cellspacing="0" style="Margin:0 auto;" align="center">
                        <tbody align="center">
                          <tr>
                            <td align="center"><table border="0" cellpadding="0" cellspacing="0" style="Margin:0 auto;">
                                <tr>
                                  <td width="250" height="60" align="center" bgcolor="#1f3ca6" style="-moz-border-radius: 30px; -webkit-border-radius: 30px; border-radius: 30px;"><a href="/StreetParking/index.html" style="width:250; display:block; text-decoration:none; border:0; text-align:center; font-weight:bold;font-size:18px; font-family: Century, sans-serif; color: #ffffff" class="button_link">Volver al menu principal</a></td>
                                </tr>
                              </table></td>
                          </tr>
                        </tbody>
                      </table>
                      <p style="color:#000000; font-size:16px; text-align:center; font-family: Century, Geneva, sans-serif; line-height:22px "><br />
                        <br />
                        <br />
                        <br />
                        <br />
